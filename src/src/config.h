...
/* Define to 1 if you have the `dlog' library (-ldlog). */
/* #undef HAVE_LIBDLOG */
...
#define PACKAGE_STRING "lxc 3.1.0-devel"
...
#define PACKAGE_VERSION "3.1.0-devel"
